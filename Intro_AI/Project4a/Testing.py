...
from DecisionTree import makeTree, setEntropy,infoGain, giniGain, giniIndex
import random

def getAverageClassificaionRate(dataset,runs=20,testSize=200,setFunc = giniIndex, infoFunc = giniGain):
    """
...
def testConnect4(setFunc = giniIndex, infoFunc = giniGain):
...
def main():
    ...
    #testCar()
    print 'WITH ENTROPY'
    testConnect4(setEntropy, infoGain)
    print 'WITH GINI'
    testConnect4(giniIndex, giniGain)
