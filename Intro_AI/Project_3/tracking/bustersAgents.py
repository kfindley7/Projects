...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for belief in livingGhostPositionDistributions:
            localMaxes.append(belief.argMax())
        
        goalCoord, goalProb = None, 0
        for index, coord in enumerate(localMaxes):
            if livingGhostPositionDistributions[index][coord] >= goalProb:
                goalCoord = coord
                goalProb = livingGhostPositionDistributions[index][coord]
